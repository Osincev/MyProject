...
class Application(tk.Tk):
    ...
    def set_ui(self):
        ...
        SetsBar.grid(row=2,column=0,columnspan=2,sticky='WE')
        bs1 = ttk.Button(SetsBar, text='Настройки 1')
        bs1.grid(row=0,column=0,sticky='we')
        bs2 = ttk.Button(SetsBar, text='Настройки 2')
        bs2.grid(row=0,column=1,sticky='WE')
